...
def get_barcods(args):
    ...
    if image.any():
        pds = compute_pds(image, max_dim=1)
    else:
        pds = []
        print(f'{os.path.basename(image_path)} : ROI is empty!\n')
...
if __name__ == '__main__':
    ...
    main_path = r'../../Datasets/kits19'
    classes = ['partial_nephrectomy', 'radical_nephrectomy']
