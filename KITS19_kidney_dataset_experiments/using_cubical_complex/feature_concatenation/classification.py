...
if __name__ == '__main__':
    ...
    main_feat_dir = 'concatenated_features'
    ...
    classes = {'partial_nephrectomy': 0, 'radical_nephrectomy': 1}
    ph_dims = [0, 1]
    ...
    for feature_list in tqdm(feature_sets):
        ...
        for c in classes.keys():
            feature_dict = {feature_name: {d: os.path.join(main_feat_dir, c, f'feature_matrix_dim_{d}_{feature_name}.csv')
                                           for d in ph_dims} for feature_name in feature_list}
